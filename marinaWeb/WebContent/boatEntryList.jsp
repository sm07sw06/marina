...
<body class="page-body" data-url="http://neon.dev">
	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li class="active"><strong>보트 입출항 내역</strong></li>
			</ol>
	
			<div class='myTitleBox'>보트 입출항 내역</div>
				<!--  search form start -->
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group ">
										...
										<input type="hidden" id="C_BOAT_CD"  name="C_BOAT_CD"   >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="input-group ">
	...
	<script src="assets/a1ck/js/boatEntryList.js"></script>		
