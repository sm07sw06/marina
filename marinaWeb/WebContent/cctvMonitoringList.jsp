...
<body class="page-body" data-url="http://neon.dev">
	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li class="active"><strong>입출항 CCTV 확인</strong></li>
			</ol>
	
			<div class='myTitleBox'>입출항 CCTV 확인</div>
				<!--  search form start -->
					...
					<form class="search-form"> 
						<div >
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group ">
										<input type="text" class="form-control" id="C_CCTV_CD"  name="C_CCTV_CD"  placeholder="이름또는 ID를 입력하세요." >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="input-group ">
					...
					<div class="col-lg-12">		  
						<div class="panel panel-primary" data-collapsed="0">
							...
							<div class="panel-heading">
								<div class="panel-title">CCTV 화면</div>
	...
	<script src="assets/a1ck/js/cctvMonitoringList.js"></script>		
