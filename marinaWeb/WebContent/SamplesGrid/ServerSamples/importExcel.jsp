<%@ page import="java.util.*, java.io.*, java.net.*, org.apache.commons.fileupload.*, org.apache.commons.io.*, org.apache.commons.codec.binary.Base64"%><%
...
final String tempPath = "/var/lib/tomcat6/webapps/ROOT/temp";		// 파일 임시 저장소
...
while (iter.hasNext()) {
	...
	if (!item.isFormField()) {						// input type="file" 인경우
		if ("fileImport".equals(item.getFieldName())) {		// rMate Grid 컴포넌트가 올린 파일의 input file명
			...
			byte[] dataByte = Base64.encodeBase64(item.get());
