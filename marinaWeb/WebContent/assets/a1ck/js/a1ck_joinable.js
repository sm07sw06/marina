...
//	  fileName = "";
      if (!!$(this).prop('files') && $(this).prop('files').length > 1) {
        //fileName = $(this)[0].files.length+' files';  //LDH
        console.log(fileName);			//LDH
        var jj = 0;
        for(var ii=0;ii<$(this)[0].files.length;ii++) {		//LDH
      	 // console.log($(this)[0].files[ii].name);
      	  if (jj==0)
      		  fileName = $(this)[0].files[ii].name;
      	  else
      		  fileName = fileName + " , " + $(this)[0].files[ii].name;
      	  jj++;
        } 
      ...
      $(this).parent().after('<span class="file-input-name"><br>'+fileName+'</span>');
    });
