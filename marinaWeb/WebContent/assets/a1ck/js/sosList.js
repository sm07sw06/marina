...
//	    async : 비동기 모드로 수행여부, 기본값 false
	function excelExport() {
		...
		dataGrid.exportTitles = [
			"구조요청 내역  보고서",	// 문자열 하나를 기본 제목 스타일로 넣을 경우
		];
		// 엑셀문서의 꼬릿말라인들을 지정합니다.
	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" verticalAlign="middle" sortableColumns="true" textAlign="center">\
			<groupedColumns>\
				...
				<DataGridColumn dataField="SEND_TIME"   	id="colSendTime"   	headerText="일시"    width="100" />\
				<DataGridColumn dataField="BOAT_NM" 		id="colBoatNm" 		headerText="보트명"  width="100" />\
				<DataGridColumn dataField="GRADE"   		id="colGrade"  		headerText="기울기"  width="100" />\
				<DataGridColumn dataField="LATITUDE"   		id="colLatitude"  	headerText="위도"  width="100" />\
				<DataGridColumn dataField="LONGITUDE"   	id="colLongitude"  	headerText="경도"  width="100" />\
			</groupedColumns>\
			<dataProvider>\
