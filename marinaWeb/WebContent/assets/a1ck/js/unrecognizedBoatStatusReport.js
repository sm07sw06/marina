	...
	function refreshData()  
	{
		...
		$.ajax({
		   	url:"GetUnrecognizedBoatStatusReport",
...
//	    async : 비동기 모드로 수행여부, 기본값 false
	function excelExport() {
		...
		dataGrid.exportTitles = [
			"기간별 미등록 보트 정박 현황",	// 문자열 하나를 기본 제목 스타일로 넣을 경우
		];
		// 엑셀문서의 꼬릿말라인들을 지정합니다.
	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" verticalAlign="middle" sortableColumns="true" textAlign="center">\
			<groupedColumns>\
				...
				<DataGridColumn dataField="LEAVE_DT"   	id="colLeaveDt"  headerText="해제일시"   width="100" />\
				<DataGridColumn dataField="TIMES"   	id="colTimes"    headerText="총정박시간"   width="100" />\
			</groupedColumns>\
			<dataProvider>\
