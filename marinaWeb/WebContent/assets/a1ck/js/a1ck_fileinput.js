...
//    	console.log("1111111111111111111");
      ...
      reader.onload = function(re) {
        ...
        $('#f_picture').attr('src','userImages/'+e.target.files[0].name);		/*  DHLEE 2018.01.15 **/
        //$('#f_picture').attr('src','userImages/'+e.target.files[0].name);		/*  DHLEE 2018.01.15 **/
      ...
      console.log("222222222222222222222222:"+ file.name);
  ...
  Fileupload.prototype.clear = function(e) {
    ...
    $('#f_picture').attr('src','images/200x150.png');		/*  DHLEE 2018.01.15 **/
