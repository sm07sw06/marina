...
//	    async : 비동기 모드로 수행여부, 기본값 false
	function excelExport() {
		...
		dataGrid.exportTitles = [
			"보트 입출항 보고서",	// 문자열 하나를 기본 제목 스타일로 넣을 경우
		];
		// 엑셀문서의 꼬릿말라인들을 지정합니다.
	...
	'<rMateGrid>\
		...
		<DataGrid id="dg1" verticalAlign="middle" sortableColumns="true" textAlign="center">\
			<groupedColumns>\
				...
				<DataGridColumn dataField="BOAT_ID" 		id="colBoatId" 		headerText="보트ID"  width="100" />\
				<DataGridColumn dataField="BOAT_NM" 		id="colBoatNm" 		headerText="보트명"  width="100" />\
				<DataGridColumn dataField="BOATINOUT_NM"   id="colBoatInoutNm"  headerText="입출항"  width="100" />\
			</groupedColumns>\
			<dataProvider>\
