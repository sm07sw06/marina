...
<body class="page-body" data-url="http://neon.dev">
	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li class="active"><strong>구역별 정박 상태 </strong></li>
			</ol>
	
			<div class='myTitleBox'>구역별 정박 상태</div>
				<!--  search form start -->
							...
							<div class="col-sm-8" >
                                 <div class="col-sm-6">                              
                                     <div >
                                         ...
                                         <%=codeClass.getComboBoxByCodeListAll("SECTORAREA", "", true) %>
                                         </select>                                                       
                                     </div>                                                  
                                 </div>
	...
	<script src="assets/a1ck/js/anchorStatusBySector.js"></script>		
