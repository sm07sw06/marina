...
//    	PropertyConfigurator.configure(System.getenv("CATALINA_HOME") + "/log4j.properties");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			sQuery += "   FROM MDDB.TB_USER_INFO U LEFT OUTER JOIN MDDB.TB_EMP E ON U.USER_CD = E.USER_CD \n ";
			sQuery += "                   LEFT OUTER JOIN MDDB.TB_CODE_DETAIL C ON E.STATE_CD = C.DETAIL_CD AND 'STATE_CD' = C.GROUP_CD \n ";
			sQuery += "  WHERE 1 = 1    \n ";
