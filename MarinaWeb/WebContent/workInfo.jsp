	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li><a href="#">기초등록</a></li>
				<li class="active"><strong>업무코드관리</strong></li>
			</ol>
	
			<div class='myTitleBox'>업무코드관리</div>
				<!--  search form start -->
				<div class=" search_cond col-lg-12">
					<form class="search-form"> 
						<div class="col-lg-8">
							<!--  input type="text" style="width:200px;" id="searchVal"  name="searchVal"  class="control" placeholder="이름또는 사번을 입력하세요."  -->
							<div class="col-lg-10">
				...
				<div class="main-sub-content" >
					...
					<div class="col-lg-8">										
						<div class="panel panel-primary" data-collapsed="0">
							...
							<div class="panel-heading">
								<div class="panel-title">업무 목록</div>
					...
					<div id="detail-area" class="col-lg-4 container-fluid">	  
						...
						<div class="panel panel-primary" data-collapsed="0">
							<!-- panel head -->
							<div class="panel-heading">
								<div class="panel-title">업무정보 상세</div>
								<div class="panel-options">
									<a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
								</div>
							</div>
							...
							<!-- panel body -->
							<div class="panel-body">
								<form role="form" method="post" name="SetWorkForm" id="SetWorkForm"  class="form-horizontal validate" action="" >
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="F_WORK_CD"  onKeyUp="this.value=this.value.toUpperCase();" placeholder="업무코드 ">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="F_WORK_NM" placeholder="업무명"  >
										</div>
									</div>
...
<script>
	...
	<script src="assets/a1ck/js/workInfo.js"></script>
