	...
	default_types_1 = [
		{
			...
			"n":"그리드 속성 제어", "c":[
				...
				{"n":"사용자지정에 의한 헤더라벨 변경", "u":"Column_HeaderLabelJsFunction"}
			]
		},{
			"n":"그리드 스타일 제어", "c":[
				...
				{"n":"3.1이전 버전 스타일 사용", "u":"SetConfig_Style3"}
			]
		},{
			"n":"그리드 이벤트 제어", "c":[
			...
			"n":"조회와 관련한 기능", "c":[
				...
				{"n":"사용자지정에 의한 스크롤팁 변경", "u":"DataGrid_ScrollTipFunction"},
			...
			"n":"엑셀(Excel)", "c":[
				...
				{"n":"Excel import append", "u":"Excel_Import_Append"},
				{"n":"Excel CSV import", "u":"Excel_CSV_Import"},
				{"n":"Excel export", "u":"Excel_Export"},
				{"n":"Excel export 제목  꼬릿말", "u":"Excel_Export_TitleFooters"},
				...
				{"n":"Excel export 읽기암호", "u":"Excel_Export_Password"}
			]
		},{
			"n":"선택 제어", "c":[
			...
			"n":"계층 및 그룹핑", "c":[
				...
				{"n":"사용자지정에 의한 그룹핑 제어", "u":"SpanGrouping_GroupingJsFunction"},
			...
			"n":"셀 병합 및 합산", "c":[
				...
				{"n":"사용자지정에 의한 병합 제어", "u":"Summary_MergeJsFunction"},
				{"n":"사용자지정에 의한 합산 제어", "u":"Summary_SummaryJsFunction"}
			]
		},{
			"n":"푸터", "c":[
				...
				{"n":"사용자지정에 의한 합산 제어", "u":"Footer_SummaryJsFunction"}
			]
		},{
			"n":"필터링 및 검색", "c":[
			...
			"n":"피벗", "c":[
				...
				{"n":"사용자지정에 의한 맨위의 열 표시 제어", "u":"PivotDataGrid_PivotHeaderLabelJsFunction"},
			]
		},{
			"n":"기타", "c":[
				{"n":"다국어 지원", "u":"Locale"},
