	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
			    ...
			    <div id="wrapper0">
						 <div id="dashBox">
							<div id="dashBox1"><div id="dashBox1Chart"></div></div>
							<div id="dashBox2"><div id="dashBox2-2Chart"></div><div id="dashBox2-1Chart"></div></div>
							<div id="dashBox3"><div id="dashBox3Chart"></div></div>
							<div id="dashBox4"><div id="dashBox4Chart"></div></div>
						</div>
						 <div id="alertBox">
							<div id="alertBox1">
...
<script>
    ...
    <script src="assets/a1ck/js/a1ck-js3.js"></script>
