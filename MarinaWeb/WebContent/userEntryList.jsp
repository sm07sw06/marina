	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li class="active"><strong>출입내역 조회</strong></li>
			</ol>
	
			<div class='myTitleBox'>출입내역 조회</div>
				<!--  search form start -->
					...
					<form class="search-form"> 
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="input-group ">
										<input type="text" style="width:200px;" id="C_USER_NM"  name="C_USER_NM"  placeholder="이름또는 ID를 입력하세요." >
									</div>
								</div>
								<div class="col-sm-2">
									<div class="input-group ">
