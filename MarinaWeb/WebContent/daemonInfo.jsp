	...
	<!-- menu end-->
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3" >
				...
				<li><a href="#">기초등록</a></li>
				<li class="active"><strong>데몬 관리</strong></li>
			</ol>
	
			<div class='myTitleBox'>데몬 관리</div>
				<!--  search form start -->
				...
				<div class="main-sub-content" >
					...
					<div class="col-lg-8">										
						<div class="panel panel-primary" data-collapsed="0">
							...
							<div class="panel-heading">
								<div class="panel-title">데몬 목록</div>
					...
					<div id="detail-area" class="col-lg-4 container-fluid">	  
						...
						<div class="panel panel-primary" data-collapsed="0">
							<!-- panel head -->
							<div class="panel-heading">
								<div class="panel-title">Daemon정보 상세</div>
								<div class="panel-options">
									<a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
								</div>
							</div>
							...
							<!-- panel body -->
							<div class="panel-body">
								<form role="form" method="post" name="SetDaemonForm" id="SetDaemonForm"  class="form-horizontal validate" action="" >
							
									<input type="hidden" class="form-control" id="CRUD" name="CRUD"  value="U">
									<input type="hidden" class="form-control" id="ROWID" name="ROWID" >
									<input type="hidden" class="form-control" id="F_DAEMON_ID" >
																	
									<div class="form-group">
										<label for="f_orgNm" class="col-sm-3 control-label">Daemon명</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="F_DAEMON_NM"  >
										</div>
									</div>
	
									<div class="form-group">
										<label for="f_orgNm" class="col-sm-3 control-label">DaemonIP</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="F_DAEMON_IP" data-mask="999.999.999"   >
										</div>
									</div>
	
									<div class="form-group">
										<label for="f_orgNm" class="col-sm-3 control-label">DaemonPort</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="F_DAEMON_PORT"   >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control wysihtml5" rows="4" data-stylesheet-url="assets/css/wysihtml5-color.css" name="F_DAEMON_DESC" id="F_DAEMON_DESC" ></textarea>
										</div>
									</div>
									
									<div class="form-group">
										<label for="f_status" class="col-sm-3 control-label">상태</label>
										<input type="hidden" class="form-control" id="F_DAEMON_STAT_NM"   >
										<div class="col-sm-8" >
											<select class="form-control" id="F_DAEMON_STAT_CD">
												<%=codeClass.getComboBoxByCodeList("DAEMON_STAT_CD", "", true) %>
											</select>
										</div>
									</div>
	
									<div class="form-group">
										<label for="f_status" class="col-sm-3 control-label">재시작여부</label>
										<div class="col-sm-8" >
									        <input class="icheck-13" type="radio" id="F_AUTO_RESTART_YN" name="F_AUTO_RESTART_YN" value="Y">
									        <label for="F_AUTO_RESTART_YN">예</label>
									        <input class="icheck-13" type="radio" id="F_AUTO_RESTART_YN" name="F_AUTO_RESTART_YN" value="N">
									        <label for="F_AUTO_RESTART_YN">아니오</label>
										</div>
									</div>
...
<script>
	...
	<script src="assets/a1ck/js/daemonInfo.js"></script>
