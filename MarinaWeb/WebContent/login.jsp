...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="username" id="username" placeholder="사번"  value="admin" autocomplete="off" />
					</div>
			...
			<div class="login-bottom-links">
				...
				<a href="forgot-password.jsp" class="link">비밀번호를 잊으셨나요?</a>
	...
	<script src="assets/a1ck/js/login.js"></script>
