...
//		      dataGrid.setSelectedIndex(idx-1);
	...
	function gridReadyHandler2(id) {
		...
		gridRoot.addEventListener("layoutComplete", layoutCompleteHandler2);
		gridRoot.addEventListener("dataComplete", dataCompleteHandler2);
		gridRoot.addEvent("dblclick", dblclickHandler2);
...
//		console.log(dataGrid.getSelectedIndex());
	...
	function refreshData2()  
	{
		...
		jsonObj.__group_cd = selectdRow.GROUP_CD;
		jsonObj.__crud = 'RD';
		jsonObj.__rows = '20';
		jsonObj.__page = '1';
