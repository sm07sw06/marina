...
//    	PropertyConfigurator.configure(System.getenv("CATALINA_HOME") + "/log4j.properties");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			sQuery += "   FROM MDDB.TB_JOB_HISTORY H LEFT OUTER JOIN MDDB.TB_CODE_DETAIL C1 ON H.SCAN_MSG_CD = C1.DETAIL_CD AND 'SCAN_STAT_CD'   = C1.GROUP_CD  \n ";
			sQuery += "                      LEFT OUTER JOIN MDDB.TB_CODE_DETAIL C2 ON H.SCAN_MSG_CD = C2.DETAIL_CD AND 'FILTER_STAT_CD' = C2.GROUP_CD  \n ";
			sQuery += "                      LEFT OUTER JOIN MDDB.TB_CODE_DETAIL C3 ON H.SCAN_MSG_CD = C3.DETAIL_CD AND 'LOAD_STAT_CD'   = C3.GROUP_CD  \n ";
			sQuery += "       ,MDDB.TB_JOB_MST J       \n ";
